...
<div id="modx-window-mi-grid-update-{$properties.tv_id}-tabs">
...
Ext.extend(MODx.combo.FormnameDropdown,Ext.form.ComboBox,{
	selectForm: function() {
		var win = Ext.getCmp('{/literal}modx-window-mi-grid-update-{$properties.tv_id}{literal}');
...
Ext.onReady(function() {    
    ...
    MODx.load({
        xtype: 'modx-tabs'
        ,applyTo: '{/literal}modx-window-mi-grid-update-{$properties.tv_id}-tabs{literal}'
        ,activeTab: 0
        ,autoTabs: true
        ,border: false
        ,plain: true
